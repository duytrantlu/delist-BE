...
function validateUser(user, callback) {
  ...
  if (typeof user.username === 'string') {
    ...
    if (!(validations.username.regex.value).test(user.username))
      return callback(new Error(validations.username.regex.message));
  } else {
    return callback(new Error('user.username is required'));
  }
